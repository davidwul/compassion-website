...
_xml_mapping = {
    "Project creation confirmation": ["config_project_confirmation", "project_join"],
    "Project published": [
        "config_project_published",
        "project_published_email_template",
    ],
    "Project joined confirmation": ["config_project_join", ""],
    "Donation successful": [
        "config_donation_successful_email_template",
        "donation_successful_email_template",
    ],
    "Donation notification": [
        "config_donation_received",
        "donation_received_email_template",
    ],
}
