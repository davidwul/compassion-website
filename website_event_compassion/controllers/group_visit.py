...
class GroupVisitController(EventsController):
    ...
    @http.route(
        "/event/<string:reg_uid>/agreements", auth="public", website=True, sitemap=False
    )
    def group_visit_step2(self, reg_uid, form_id=None, **kwargs):
        registration = (
            request.env["event.registration"].sudo().search([("uuid", "=", reg_uid)])
        )
    ...
    @http.route(
        "/event/<string:reg_uid>/down_payment",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/gpv_payment",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/medical_checklist",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/medical_discharge",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/meeting_invitation",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/after_party",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/meeting_confirm",
        auth="public",
        website=True,
        sitemap=False,
    )
    ...
    @http.route(
        "/event/<string:reg_uid>/meeting_decline",
        auth="public",
        website=True,
        sitemap=False,
    )
