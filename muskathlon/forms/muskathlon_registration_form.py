...
class MuskathlonRegistrationForm(models.AbstractModel):
    ...
    def gtc(self):
        html_file = file_open(
            f"muskathlon/static/src/html/muskathlon_gtc_{self.env.lang}.html"
        )
        text = html_file.read()
        html_file.close()
        statement = self.env["compassion.privacy.statement"].sudo().search([], limit=1)
    ...
    def form_next_url(self, main_object=None):
        ...
        return f"/muskathlon_registration/{self.main_object.id}/success"
